...
namespace Clockwork.Core.Formats.NDS.NSBMD
{
    ...
    public static class GLLegacy
    {
        ...
        public static void MatrixMode(int mode) { /* noop */ }
        public static void Translatef(float x, float y, float z) { /* noop */ }
        public static void PushMatrix() { /* noop */ }
        public static void PopMatrix() { /* noop */ }
    }
}
