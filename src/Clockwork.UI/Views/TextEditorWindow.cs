...
namespace Clockwork.UI.Views
{
    ...
    public class TextEditorWindow : IView
    {
        ...
        private void DrawSplitView()
        {
            ...
            ImGui.BeginChild("MessageList", new Vector2(listWidth, -30), ImGuiChildFlags.Borders);
            {
            ...
            ImGui.BeginChild("MessageEditor", new Vector2(editorWidth, -30), ImGuiChildFlags.Borders);
            {
                if (selectedMessageIndex >= 0 && selectedMessageIndex < messages.Count)
                {
